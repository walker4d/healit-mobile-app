                  ...
                  return Card(
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          leading: Icon(Icons.arrow_drop_down_circle),
                          title: Text(news[index].author != null
                              ? news[index].author
                              : 'unkown author'),
                          subtitle: Text(
                            news[index].title,
...
Future<List<NNews>> getNews() async {
  ...
  for (var item in jsonData["articles"]) {
    NNews news = new NNews(item['title'], item['urlToImage'],
        item['publishedAt'], item['description'], item['author']);
...
class NNews {
  ...
  NNews(
      this.title, this.image, this.publishedAt, this.description, this.author);
}
